...
- `docker-compose ps` `docker image ls`
- `docker inspect <tag or id>`
- You can bring everything down, removing the containers entirely. Pass volumes to also remove the data volume used by the Redis container: `docker-compose down --volumes`
...
- Dockerfile / Python 3 parent image / WORKDIR / ADD / RUN
- reqirements.txt / the required software
- docker-compose.yml / a web server and database / images / volumes / ports

- Create project
  - `docker-compose run web django-admin.py startproject composeexample .`
  - Change the ownership of the new files: `sudo chown -R $USER:$USER .`
